...
const Traininglist: React.FC = () => {
  ...
  // data for ag-grid
  const columns: ColDef<ExistingTraining>[] = [
    { field: "activity", headerName: "Activity", sortable: true, filter: true },
    {
      headerName: "Date",
      field: "date", // Ensure this field exists in ExistingTraining
      sortable: true,
      filter: true,
    ...
    {
      field: "duration", // Ensure this field exists in ExistingTraining
    ...
    {
      headerName: "",
      field: "id", // Ensure this field exists in ExistingTraining
      width: 65,
  ...
  return (
    <div className="App">
      ...
      <div
        ...
        style={{ height: 593, width: "85%", maxWidth: "900px", margin: "auto" }}
      >
        <AgGridReact<ExistingTraining>
          rowData={trainings}
          columnDefs={columns}
          pagination={true}
